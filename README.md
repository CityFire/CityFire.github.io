...
[![GitHub Pages](https://img.shields.io/badge/GitHub%20Pages-Active-green)](https://cityfire.github.io)
...
🔗 **博客地址**: [https://cityfire.github.io](https://cityfire.github.io)
...
- **技术标签**: `iOS`, `Swift`, `SwiftUI`, `Flutter`, `HarmonyOS`
- **架构标签**: `架构`, `设计模式`, `微服务`
- **AI标签**: `AI`, `机器学习`, `深度学习`, `大模型`
- **语言标签**: `Swift`, `C++`, `仓颉`, `Java`

## 🔗 相关链接

- **博客首页**: [https://cityfire.github.io](https://cityfire.github.io)
- **文章索引**: [source/_posts/README.md](source/_posts/README.md)
- **GitHub 仓库**: [https://github.com/CityFire/CityFire.github.io](https://github.com/CityFire/CityFire.github.io)
...
- [Butterfly](https://github.com/jerryc127/hexo-theme-butterfly) - 精美的 Hexo 主题
- [GitHub Pages](https://pages.github.com) - 免费的静态网站托管服务

---

**维护者**: [CityFire](https://github.com/CityFire)
